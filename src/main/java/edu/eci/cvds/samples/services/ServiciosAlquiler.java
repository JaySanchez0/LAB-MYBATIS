...
public interface ServiciosAlquiler {
   ...
   */
   public abstract List<Item> consultarItemsDisponibles() throws UnsupportedOperationException;
   ...
   */
   ...
   public abstract ItemRentado getItemRentado(int id) throws ExcepcionServiciosAlquiler;
